...
public class PaisController implements Serializable {
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        return getSelectPaises(ejbFacade.paises_ordenados(), true);
    }
    
    public static SelectItem[] getSelectPaises(List<Pais> entities, boolean selectOne) {
        int size = selectOne ? entities.size() + 1 : entities.size();
        SelectItem[] items = new SelectItem[size];
        int i = 0;
        if (selectOne) {
            items[0] = new SelectItem("", "Selecciona un pais");
            i++;
        }
