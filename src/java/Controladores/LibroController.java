...
public class LibroController implements Serializable {
    ...
    @EJB
    private Facades.LibroFacade ejbFacade;
    ...
    public PaginationHelper getPagination() {
        if (pagination == null) {
            pagination = new PaginationHelper(getItemsAvailableSelectMany().length-1) {
    ...
    public void cargarLibrosAutor() {
        libros = ejbFacade.libros_autor(autor);
    }
